...
void gola(int who){ // This is initiated whenever a goal happens. Here who defines whoever accepted the goal
	...
	settextstyle(0,0,5);
	char *c;
	if(moves>1) c="GOAL !!"; // if more than 1 moves are played then goal occurs.
	else if(moves==1) c="FOUL !!"; // if goal is done in first move it will me considered a foul
...
/*
Check Collision() integer type function was defined instead of just a normal collisions because in normal collisiosn function 
